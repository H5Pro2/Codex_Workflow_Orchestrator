...
export function maintenanceDiagnosticPrompt(incident, context = '') {
  return [
    ...
    '',
    'Behandle die Initial-Invariante als feste Systemregel:',
    '- Pro Projekt gibt es höchstens einen neutralen Initial-Baustein.',
    '- Dieser Initial gehört ausschließlich zum CEO und darf nur direkt zum CEO führen.',
    '- Eine optionale Initial-Anweisung ist nur erlaubt, wenn sie ausdrücklich vom Benutzer gespeichert wurde.',
    '- Automatisch erzeugte Aufgaben, Rollen-Prompts und unmarkierte alte Inhalte dürfen niemals als Initial-Anweisung ausgeführt werden.',
    '- Ein Initial bei einem Fachagenten oder ein anderes Initial-Ziel ist ein Konfigurationsfehler.',
    '- Melde einen solchen Verstoß im Diagnosebericht an den CEO, aber ändere oder repariere ihn nicht selbst.',
    '',
