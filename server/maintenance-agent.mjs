...
export function maintenanceDiagnosticPrompt(incident, context = '') {
  return [
    ...
    '- Dieser Initial gehört ausschließlich zum CEO, enthält keine fachliche Aufgabe und darf nur direkt zum CEO führen.',
    '- Ein Initial bei einem Fachagenten, eine fachliche Initial-Anweisung oder ein anderes Initial-Ziel ist ein Konfigurationsfehler.',
