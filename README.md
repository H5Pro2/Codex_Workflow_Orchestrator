...
Der CEO ist ausschließlich Teamleiter. Er verwaltet, organisiert, vergibt Aufgaben, überwacht Ergebnisse und trifft Entscheidungen. Er programmiert nicht, verändert keine fachlichen Projektdateien, führt keine Implementierungsarbeit aus und übernimmt keine Spezialistenrolle. Diese Grenze wird bei direkten CEO-Nachrichten, Initial-Starts, Rückgaben aus dem Workflow und Überwachungsaufgaben erneut als vorrangige Laufzeitregel übermittelt. In den CEO-Optionen sind die verbindlichen Basisanweisungen einsehbar. Dort können außerdem zusätzliche organisatorische CEO-Anweisungen dauerhaft ergänzt werden; Erweiterungen dürfen die Basisregeln nicht aufheben.
