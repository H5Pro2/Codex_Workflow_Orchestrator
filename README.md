...
Im Setup jedes Agenten steuert `Projektwissen verwenden`, ob dieser Agent den aktivierten Quellenkatalog erhält. Der Schalter ist für bestehende und neue Agenten standardmäßig aktiv. Ist er ausgeschaltet, werden dem Agenten bei keiner direkten Nachricht und keiner automatischen Workflow-Übergabe Wissensquellen mitgegeben. Eine separate Datenbankauswahl ist nicht erforderlich, weil immer die Datenbank des zugehörigen Projekts gilt.
